    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-start border-success border-3">
            <div class="card-body">
                ...
                <div class="mt-3">
                    <!-- تغيير الراوت إلى المسار الصحيح -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mt-3 text-center">
                    <!-- إذا كان لديك مغسلة، أضفها كباراميتر -->
                    @if(isset($carWash) && $carWash)
                        <a href="{{ route('carWash.orders.selectStatus', $carWash) }}" class="btn btn-outline-primary btn-sm">
                            عرض جميع الطلبات
                        </a>
                    @else
    ...
    <div class="col-xl-8 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                @if(isset($carWash) && $carWash)
                    <a href="{{ route('carWash.orders.selectStatus', $carWash) }}" class="btn btn-sm btn-outline-primary">
                        عرض الكل
                    </a>
                @endif
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3 col-6">
                        <!-- مراجعة الراوت إذا كان يحتاج carWash parameter -->
                        @if(isset($carWash) && $carWash)
                            <a href="{{ route('carWash.orders.selectStatus', $carWash) }}" class="btn btn-outline-success w-100 h-100 py-3">
                    ...
                    <div class="col-md-3 col-6">
                        <!-- خدمات تحتاج carWash parameter -->
                        @if(isset($carWash) && $carWash)
                            <a href="{{ route('services.index', $carWash) }}" class="btn btn-outline-warning w-100 h-100 py-3">
                    ...
                    <div class="col-md-3 col-6">
                        <!-- مواعيد العمل تحتاج carWash parameter -->
                        @if(isset($carWash) && $carWash)
                            <a href="{{ route('car-wash-working-hours.index', $carWash) }}" class="btn btn-outline-info w-100 h-100 py-3">
