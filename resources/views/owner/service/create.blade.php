                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            value="{{ old('name') }}"
                                            placeholder="أدخل اسم الخدمة (مثال: غسيل خارجي كامل)" required>
                                        @error('name')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">السعر ( جنية مصرى) <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="number" name="price" id="price"
                                                class="form-control @error('price') is-invalid @enderror"
                                                value="{{ old('price') }}" placeholder="0.00" min="0" step="0.01"
                                                required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="duration"
                                                ...
                                                value="{{ old('duration', 30) }}" placeholder="30" min="1"
                                                step="1">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="status" class="form-select @error('status') is-invalid @enderror">
                                            <option value="active"
                                                {{ old('status', 'active') == 'active' ? 'selected' : '' }}>نشطة</option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="available_for_online"
                                            id="availableOnline" {{ old('available_for_online', true) ? 'checked' : '' }}>
